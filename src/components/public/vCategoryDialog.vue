<template>
  <el-dialog :title="ifCreate ? '创建分类' : '编辑'" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
        ...
        <listBoxF>
          <template slot="content">
            <treeselect class="treeSelect-option" v-model="value" :multiple="multiple" :normalizer="normalizer"
              :options="list" placeholder="请选择" @select="selectNode" style="width:455px;" />
          </template>
        </listBoxF>
      </el-form-item>
