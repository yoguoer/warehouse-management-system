<template>
  <div style="background:#fff;padding:10px;">
    ...
    <purchaseIntegrateEdit v-if="drawer" :drawer="drawer" :rowData="rowData" @close="drawer = false" @success="success()" />
  </div>
</template>
...
import purchaseIntegrateEdit from "./purchaseIntegrateEdit";
