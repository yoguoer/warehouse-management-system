  ...
  computed: {
    tableColumn() {
      return [
        ...
        { prop: "occupyNum", label: "占用订单", width: "150px", sortable: true },
        { prop: "occupySum", label: "占用数量", width: "150px", sortable: true },
        { prop: "outputNum", label: "出库订单", width: "150px", sortable: true },
        { prop: "outputSum", label: "出库数量", width: "150px", sortable: true },
        { prop: "returnCount", label: "有退货订单", width: "150px", sortable: true },
        { prop: "returnSum", label: "退货数量", width: "150px", sortable: true },
        { slots: { name: "column-rate" }, label: "退货率", width: "150px", sortable: true },
