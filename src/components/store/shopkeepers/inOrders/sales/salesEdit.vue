      ...
      <el-row>
        ...
        <el-col :span="10">
          <el-form-item label="计划出库数" prop="outputPlan">
            <el-input v-model="ruleForm.outputPlan" clearable :min="0" placeholder="计划出库数" type="Number"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="10">
          <el-form-item label="出库价格" prop="outputPrice">
            <el-input v-model="ruleForm.outputPrice" clearable :min="0" placeholder="出库价格" type="Number"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
      ...
      <el-row v-if="output">
        ...
        <el-col :span="10">
          <el-form-item label="实际数" prop="outputActual">
            <el-input v-model="ruleForm.outputActual" clearable :min="0" placeholder="实际数" type="Number"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-if="output">
