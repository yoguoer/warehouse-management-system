  ...
  computed: {
    tableColumn() {
      return [
        ...
        { prop: "checkNum", label: "申请退货数", width: "100px" },
        { prop: "returnNum", label: "实际退货数", width: "100px" },
        { prop: "returnReason", label: "退货原因" },
        { slots: { name: "column-status" }, label: "审批状态" },
        { prop: "description", label: "审批意见" },
        { slots: { name: "column-happenTime" }, label: "申请日期", sortable: true, width: "150px" },
        { slots: { name: "column-checkTime" }, label: "审批日期", sortable: true, width: "150px" },
