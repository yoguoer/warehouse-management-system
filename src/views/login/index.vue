      ...
      <div class="login-fr fl">
        ...
        <el-form ref="ruleForm" :model="formdata" :rules="rules">
          <el-form-item prop="userPhone" v-if="tabval !== '注册'">
            <el-input placeholder="用户手机" @keyup.enter.native="submitform('ruleForm',tabval)" v-model="formdata.userPhone"></el-input>
          </el-form-item>
          <template v-if="tabval == '注册'">
            <el-form-item prop="userName" >
              <el-input type="text" placeholder="姓名" v-model="formdata.userName" @keyup.enter.native="submitform('ruleForm',tabval)" maxlength="20"/>
            </el-form-item>
            <el-form-item prop="userPhone">
              <el-input type="text" placeholder="手机号码"  v-model="formdata.userPhone" @keyup.enter.native="submitform('ruleForm',tabval)" maxlength="20"/>
            </el-form-item>
            <el-form-item prop="userEmail">
              <el-input type="text"  placeholder="邮箱" v-model="formdata.userEmail" @keyup.enter.native="submitform('ruleForm',tabval)" maxlength="20"/>
            </el-form-item>
          ...
          <el-form-item prop="passWord">
            <el-input placeholder="密码" @keyup.enter.native="submitform('ruleForm',tabval)"  type="passWord" v-model="formdata.passWord"></el-input>
          </el-form-item>

          <template v-if="tabval == '注册'">
            <el-form-item  prop="checkPass">
              <el-input  placeholder="确认密码" ref="surepassWord" type="passWord" v-model="formdata.checkPass" @keyup.enter.native="submitform('ruleForm',tabval)" maxlength="20" />
            </el-form-item>
          </template>
          ...
          <el-form-item>
            <el-button @click="submitform('ruleForm',tabval)" @keyup.enter="submitform('ruleForm',tabval)">{{tabval}}</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
